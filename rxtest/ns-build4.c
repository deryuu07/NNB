					...
					if(next_R < 1000){
						if(ch_frag==0){
							if(ENC_dis[ENC_count+1]*mmpp > 300.0){
								if(next_R < 200) 					Desire_next_speed=curve_speed_para[R10];
								if(next_R >= 200 && next_R < 300) 	Desire_next_speed=curve_speed_para[R20];
								if(next_R >= 300 && next_R < 400){	Desire_next_speed=curve_speed_para[R30];	LED_manager(10);}
								if(next_R >= 400 && next_R < 500) 	Desire_next_speed=curve_speed_para[R40];
								if(next_R >= 500 && next_R < 600) 	Desire_next_speed=curve_speed_para[R50];
								...
								if(next_R >= 800) 					Desire_next_speed=curve_speed_para[R80];
								else{}
							}
							else{
...
//						K_D=first_K_D*2.5;
					...
					if(ch_frag==0){
						if(now_comp_distance > 300.0){
							...
							if(now_R >= 150 && now_R < 200){
								Desire_next_speed=curve_speed_para[R10];
								K_P=first_K_P*1.2;							
							}
							if(now_R >= 200 && now_R < 300){
								Desire_next_speed=curve_speed_para[R20];
								K_P=first_K_P*1.1;
							}
							if(now_R >= 300 && now_R < 400){	
								Desire_next_speed=curve_speed_para[R30];	
								LED_manager(10);
							}
							if(now_R >= 400 && now_R < 500)
							 	Desire_next_speed=curve_speed_para[R40];
							if(now_R >= 500 && now_R < 600)
							 	Desire_next_speed=curve_speed_para[R50];
							if(now_R >= 600 && now_R < 700) 
								Desire_next_speed=curve_speed_para[R60];
							if(now_R >= 700 && now_R < 800) 
								Desire_next_speed=curve_speed_para[R70];
							if(now_R >= 800) 								
								Desire_next_speed=curve_speed_para[R80];
							else{}
						}
						else{
							Desire_next_speed=curve_speed_para[R10];
...
void select_speed()
{
	...
	while(select_frag==0){
		...
		if(ave_SEN[1] > 180.0){
			...
			curve_speed_para[R15]=Desire_vel_nomal;1.5;
			curve_speed_para[R20]=Desire_vel_nomal*1.5;
			curve_speed_para[R25]=Desire_vel_nomal*1.5;
			curve_speed_para[R30]=Desire_vel_nomal*1.8;
			curve_speed_para[R35]=Desire_vel_nomal*1.8;
			curve_speed_para[R40]=Desire_vel_nomal*1.8;
			curve_speed_para[R45]=Desire_vel_nomal*1.9;
			curve_speed_para[R50]=Desire_vel_nomal*1.9;
			curve_speed_para[R55]=Desire_vel_nomal*1.9;
			curve_speed_para[R60]=Desire_vel_nomal*1.9;
			curve_speed_para[R65]=Desire_vel_nomal*1.9;
			curve_speed_para[R70]=Desire_vel_nomal*1.9;
			curve_speed_para[R75]=Desire_vel_nomal*1.9;
			curve_speed_para[R80]=Desire_vel_nomal*1.9;
			curve_speed_para[R85]=Desire_vel_nomal*1.9;
			curve_speed_para[R90]=Desire_vel_nomal*1.9;
			curve_speed_para[R95]=Desire_vel_nomal*1.9;
			calc_speed(Desire_vel);
