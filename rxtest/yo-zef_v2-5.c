...
int calc_senc()
{
	...
	if(start0==1){
		...
		if((ave_SEN[2] > thre_max) && (ave_SEN[3] < thre_max2 && ave_SEN[4] < thre_max2 && ave_SEN[5] < thre_max2 && ave_SEN[6] < thre_max2)){
			max_frag=1;
		}
		if(ave_SEN[3] > thre_max || ave_SEN[4] > thre_max || ave_SEN[5] > thre_max || ave_SEN[6] > thre_max)
			max_frag=0;
		
		if((ave_SEN[1] < thre_max2 && ave_SEN[2] < thre_max2 && ave_SEN[3] < thre_max2 && ave_SEN[4] < thre_max2) && (ave_SEN[5] > thre_max)){
			min_frag=1;
		}
